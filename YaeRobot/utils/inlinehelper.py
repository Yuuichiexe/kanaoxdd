...
from YaeRobot import OWNER_ID, pgram, arq
from YaeRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from YaeRobot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/YaeRobot?start=start"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/e5ba8eb7e814122701f70.jpg",
...
async def alive_function(answers):
   ...
   # ubot_state = 'Dead' if not await app2.get_me() else 'Alive'
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/YaeRobot"),
        InlineKeyboardButton("Go Inline", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[YaeRobot  剣](https://t.me/YaeRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [BOT](t.me/YaeRobot) | [OWNER](t.me/Xelcius)
"""
    ...
    answers.append(
        InlineQueryResultPhoto(
            ...
            thumb_url="https://telegra.ph/file/e5ba8eb7e814122701f70.jpg",
            photo_url="https://telegra.ph/file/b107bfa4b8f807f0126ec.jpg",
            caption=msg,
            reply_markup=buttons,
        )
    )
