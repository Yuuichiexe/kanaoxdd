...
from YaeRobot.modules.helper_funcs.miku_misc import article
from YaeRobot.modules.helper_funcs.decorators import kiginline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Saber",
            "description": "YaeRobot Inline",
            "message_text": "Click the button below to get the Saber Inline.",
            "thumb_urL": "https://telegra.ph/file/a00b4efa17ecb3b7c964a.jpg",
            "keyboard": ".saber",
        },
        {
            "title": "Kaizuryu",
        ...
        {
            "title": "Account info on Saber",
            "description": "Look up a Telegram account in Saber database",
            "message_text": "Click the button below to look up a person in Saber database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/bcab4376aed7338e61585.jpg",
            "keyboard": ".info",
        },
        {
            "title": "Help",
            ...
            "thumb_urL": "https://telegra.ph/file/b9aa2e5ebd5909f4dc799.jpg",
            "keyboard": ".help",
        },
        {
            "title": "Anilist",
            ...
            "thumb_urL": "https://telegra.ph/file/41dbe452f5f5aa83e0733.jpg",
            "keyboard": ".anilist",
        },
    ]
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a part Developer of Saber"
        nation_level_present = True
...
def saber(query: str, update: Update, context: CallbackContext) -> None:
    """Handle the inline query."""
    query = update.inline_query.query
    user_id = update.effective_user.id
    user = context.bot.get_chat(user_id)
    ...
    results.append(
        InlineQueryResultPhoto(
            id=str(uuid4()),
            title="Saber",
            description="Get Saber Inline",
            thumb_url="https://telegra.ph/file/a00b4efa17ecb3b7c964a.jpg",
            photo_url="https://telegra.ph/file/a00b4efa17ecb3b7c964a.jpg",
            caption=about_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
...
def help(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            photo_url="https://telegra.ph/file/ace91d9ae6af3881d3940.jpg",
            caption=help_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
