...
import YaeRobot.modules.helper_funcs.fun_strings as fun
from YaeRobot import LOGGER, DEV_USERS, dispatcher
from YaeRobot.modules.disable import (
    DisableAbleCommandHandler,
    DisableAbleMessageHandler,
)
from YaeRobot.modules.helper_funcs.alternate import typing_action
from YaeRobot.modules.helper_funcs.extraction import extract_user
from YaeRobot.modules.helper_funcs.filters import CustomFilters
...
def sex(update, context):
    ...
    reply_text(random.choice(fun.SEX))
...
__help__ = """
Something extra for fun or whatever!
...
*Regex based memes:*
`/decide` (disabled rn) can be also used with regex like: `YaeRobot Forger What? <question>: randomly answer "Yes, No" etc.`
Some other regex filters are:
`me too`.

YaeRobot Forger will reply random strings accordingly when these words are used!
...
HEMTAI_HANDLER = DisableAbleCommandHandler("hemtai", hemtai, run_async=True)
