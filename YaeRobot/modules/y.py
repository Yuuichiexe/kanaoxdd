...
from YaeRobot.modules.disable import MessageHandler
from telegram.ext import run_async, Filters
from telegram import Message

OWO = (
    "*YaeRobot  pats {} on the head.",
    "*gently rubs {}'s head*.",
    "*YaeRobot  mofumofus {}'s head*",
    "*YaeRobot  messes up {}'s head*",
    "*YaeRobot  intensly rubs {}'s head*",
