...
from YaeRobot import telethn as bot
    ...
    try:
        ...
        if png_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}'s Pack :: @YaeRobot" + extra_version,
...
Credit = "This Plugin Made by U N K N O W N (@U N K N O W N), if you're using this code in your bot. there is no issue but don't remove this line" 
