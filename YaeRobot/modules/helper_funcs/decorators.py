...
from YaeRobot import dispatcher as d, LOGGER
...
kigcmd = AsukaTelegramHandler(d).command
kigmsg = AsukaTelegramHandler(d).message
kigcallback = AsukaTelegramHandler(d).callbackquery
kiginline = AsukaTelegramHandler(d).inlinequery
