    ...
    if len(pairs) > 8:
        pairs = pairs[modulo_page * 8:8 * (modulo_page + 1)] + [
            (EqInlineKeyboardButton("◁", callback_data="{}_prev({})".format(prefix, modulo_page)),
                EqInlineKeyboardButton("Updates", url="https://t.me/NexusXSupport"),
             EqInlineKeyboardButton("▷", callback_data="{}_prev({})".format(prefix, modulo_page)))]

    else:
        pairs +=[[EqInlineKeyboardButton("Updates", url="https://t.me/NexusXSupport")]]
