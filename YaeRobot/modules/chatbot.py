...
import html
import requests
import YaeRobot.modules.sql.chatbot_sql as sql
...
from YaeRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from YaeRobot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "YaeRobot Forger Chat Bot Disabled by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "YaeRobot Forger Chat Bot Enabled By {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
