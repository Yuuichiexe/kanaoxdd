...
from YaeRobot.modules.helper_funcs.anonymous import AdminPerms, user_admin

from YaeRobot import dispatcher
from YaeRobot.modules.helper_funcs.decorators import YaeRobotcallback
...
@YaeRobotcallback(pattern=r"cb_approve=")
...
@YaeRobotcallback(pattern=r"cb_decline=")
@user_admin(AdminPerms.CAN_INVITE_USERS, )
@loggable
