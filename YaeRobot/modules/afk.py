...
from YaeRobot.modules.redis.afk_redis import start_afk, end_afk, is_user_afk, afk_reason
from YaeRobot import REDIS
from YaeRobot.modules.users import get_user_id

from YaeRobot.modules.helper_funcs.alternate import send_message
from YaeRobot.modules.helper_funcs.readable_time import get_readable_time
...
def afk(update, context):
    ...
    try:
        update.effective_message.reply_text(
            "{} Stay With Me Pwease...".format(fname))
    except BadRequest:
        pass
