...
import YaeRobot.modules.sql.welcome_sql as sql
from YaeRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from YaeRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from YaeRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from YaeRobot.modules.helper_funcs.msg_types import get_welcome_type
from YaeRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from YaeRobot.modules.log_channel import loggable
from YaeRobot.modules.sql.global_bans_sql import is_user_gbanned
...
Saber_IMG = "https://telegra.ph/file/8d393651c1544cfe17def.mp4"
Saber = "https://telegra.ph/file/9e9e1112a16894e7998cf.jpg"
Saber_VID = "https://telegra.ph/file/8d393651c1544cfe17def.mp4"
WAIFUS_IMG = "https://telegra.ph/file/d9c46e3db8952c020256b.jpg"
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                Saber_IMG, caption= "Behold, Saber 剣's Creator Joined Your Chat.",
                    reply_to_message_id=reply)
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Damn! Dev Ka Choda Of This Bot Just Joined, Kick Him.",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                Saber, caption= "Ohh, Sudo Ka Choda Joined Your Group, Kick Him!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_photo(
                Saber, caption= "Huh! Someone with a B Rank Hunter level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                Saber, caption= "Oof! A C Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                Saber, caption= "Oof! A D Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_photo(
                    WAIFUS_IMG, caption= "Hey {}, I'm {}! Thanks For Adding Me To {}\n"
                    "I'll Be Sure To Make It More Fun Here, Do Check Out The Buttons Below!".format(
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_video(
                Saber_VID, caption= "Oh Crap! My Creator Left..", reply_to_message_id=reply)
                return

            # Give the devs a special goodbye
            elif left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the @Anime_Tenki!",
                    reply_to_message_id=reply,
                )
                return
