...
import YaeRobot.modules.SaberFunBot_Strings as fun_strings
from YaeRobot import dispatcher
from YaeRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
...
import YaeRobot.modules.helper_funcs.string_store as fun
...
def hemtai(update: Update, context: CallbackContext):
    ...
    reply_text(random.choice(fun_strings.HEMTAI))
