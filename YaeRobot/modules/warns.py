...
from YaeRobot import dispatcher  # BAN_STICKER
...
from YaeRobot.modules.helper_funcs.extraction import (
    extract_text,
...
from YaeRobot.modules.helper_funcs.string_handling import split_quotes
from YaeRobot.modules.log_channel import loggable
from YaeRobot.modules.sql import warns_sql as sql
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Rules", url="http://t.me/YaeRobot?start={}".format(chat.id)
                    )
                ]
            ]
        )
